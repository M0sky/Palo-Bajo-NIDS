...
Se recomienda que el usuario configure las imágenes localmente siguiendo la documentación oficial de GNS3 y las instrucciones del laboratorio para obtener un entorno funcional. Para configuraciones de red y scripts relacionados, consultar la carpeta [deployment/networking](../deployment/networking)
